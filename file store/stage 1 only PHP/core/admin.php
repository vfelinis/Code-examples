			...
			<?php
				...
				foreach ($users as $user) {
					...
					echo '<tr>
							...
							<td>'.$count.'</td>
							<td>'.$admin.'</td>
							<td><a href="/core/action.php?user_id='.$user->id.'" class="btn btn-default">'.$action.'</a></td>
							<td><a href="/core/detail.php?user_id='.$user->id.'&user_email='.$user->email.'" class="btn btn-default">Подробнее</a></td>
						  </tr>';
				}
				$con->close();
			?>
