...
<a href="/core/add.php" class="btn btn-default btn-lg">Добавить новый документ</a>
...
<table class="table table-striped">
	...
	while ($document = $list->getNext()) {
		...
		echo '<tr>
				  <td><a href="/core/getFile.php?file_id='.$file_id.'">'
				  .$file_name.
				  '</a></td>
			      <td>'.$document['text'].'</td>
			      <td>'.$document['date'].'</td>
			      <td><a href="/core/update.php?id='.$document['_id'].'" class="btn btn-default">Изменить</a></td>
			      <td><a href="/core/delete.php?id='.$document['_id'].'" onclick="return confirmDelete();" class="btn btn-default">Удалить</a></td>
			  </tr>';
	}
	$con->close();
	?>
